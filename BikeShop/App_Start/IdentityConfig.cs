...
namespace BikeShop
{
    ...
    public class ApplicationUserManager : UserManager<User, Guid>
    {
        ...
        {
            var manager = new ApplicationUserManager(new CustomUserStore(context.Get<BikeShopDb>()));
    ...
    {
        public CustomUserStore(BikeShopDb context)
            : base(context)
        {
        }
    }

    public class CustomRoleStore : RoleStore<Role, Guid, UserRole>
    {
        public CustomRoleStore(BikeShopDb context)
            : base(context)
        {
        }
    }
